...
namespace StockSystem.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        public DbSet<StockSystem.Models.Branch> Branch { get; set; }

        public DbSet<StockSystem.Models.BranchProduct> BranchProduct { get; set; }

        public DbSet<StockSystem.Models.CategoryProduct> CategoryProduct { get; set; }

        public DbSet<StockSystem.Models.ProviderProduct> ProviderProduct { get; set; }
    }
}
